...
import 'schema/leave_record.dart';
import 'schema/settings_record.dart';
import 'schema/notifications_record.dart';
import 'schema/payroll_record.dart';
import 'schema/events_record.dart';
import 'schema/schedule_record.dart';
import 'schema/attendance_out_record.dart';
...
export 'schema/leave_record.dart';
export 'schema/settings_record.dart';
export 'schema/notifications_record.dart';
export 'schema/payroll_record.dart';
export 'schema/events_record.dart';
export 'schema/schedule_record.dart';
export 'schema/attendance_out_record.dart';
...
/// Functions to query LeaveRecords (as a Stream and as a Future).
Future<int> queryLeaveRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
...
Stream<List<LeaveRecord>> queryLeaveRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      LeaveRecord.collection,
      LeaveRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<LeaveRecord>> queryLeaveRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query PayrollRecords (as a Stream and as a Future).
Future<int> queryPayrollRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
...
Stream<List<PayrollRecord>> queryPayrollRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      PayrollRecord.collection,
      PayrollRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<PayrollRecord>> queryPayrollRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query AttendanceOutRecords (as a Stream and as a Future).
Future<int> queryAttendanceOutRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      AttendanceOutRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<AttendanceOutRecord>> queryAttendanceOutRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      AttendanceOutRecord.collection,
      AttendanceOutRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<AttendanceOutRecord>> queryAttendanceOutRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
