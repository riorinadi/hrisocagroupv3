...
import 'modal_employee_model.dart';
export 'modal_employee_model.dart';

class ModalEmployeeWidget extends StatefulWidget {
  const ModalEmployeeWidget({super.key});

  @override
  State<ModalEmployeeWidget> createState() => _ModalEmployeeWidgetState();
}

class _ModalEmployeeWidgetState extends State<ModalEmployeeWidget>
    with TickerProviderStateMixin {
  late ModalEmployeeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModalEmployeeModel());
