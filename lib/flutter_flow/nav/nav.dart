    ...
    GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ...
              : DashboardWidget(
                  ...
                  officeDistance: params.getParam(
                    'officeDistance',
                    ParamType.double,
                  ),
        ...
        FFRoute(
          name: 'Office',
          path: '/office',
          builder: (context, params) => const OfficeWidget(),
        ),
        FFRoute(
          name: 'ChooseOffice',
          path: '/chooseOffice',
          builder: (context, params) => const ChooseOfficeWidget(),
        ),
        FFRoute(
          name: 'HistoryAttendance',
          path: '/historyAttendance',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'HistoryAttendance')
              : const HistoryAttendanceWidget(),
        ),
        FFRoute(
          name: 'ReportAttendance',
          path: '/reportAttendance',
          builder: (context, params) => const ReportAttendanceWidget(),
        ),
        FFRoute(
          name: 'Leave',
          path: '/leave',
          builder: (context, params) => const LeaveWidget(),
        ),
        FFRoute(
          name: 'Notification',
          path: '/notification',
        ...
        FFRoute(
          name: 'DetailEvents',
          path: '/detailEvents',
          builder: (context, params) => const DetailEventsWidget(),
        ),
        FFRoute(
          name: 'schedule',
          path: '/schedule',
